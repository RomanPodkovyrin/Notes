...
---
# 1. :cloud: AZ-900 Fundamentals

## 1.1. Describe Cloud concepts

### 1.1.1. Describe Cloud computing

#### 1.1.1.1. :question: What is cloud computing

`Cloud computing` is the delivery of computing services over the internet, including:

!!! info "Common IT infrastructure"
    - Virtual Machines
    - Storage
    - Databases
    - Networking

!!! tip "Expanded IT infrastructure"
    - Internet of Things (IoT)
    - Machine Learning (ML)
    - Artificial Intelligence (AI)

:rocket: Your IT infrastructure can be rapidly expanded by getting more bandwidth or features.

#### 1.1.1.2. :balance_scale: Describe the shared responsibility model

**Traditional Corporate DataCenter**

!!! info "Company responsibilities"
    - Maintaining the physical space
    - Ensuring security
    - Maintaining or replacing servers

!!! info "IT department responsibilities"
    - Maintaining infrastructure and software
    - Keeping systems patched and on correct versions

**Shared Responsibility Model**

Responsibilities are shared between the cloud provider and the consumer.

!!! info "Cloud provider responsibilities"
    - Physical security
    - Power
    - Cooling
    - Network connectivity

!!! info "Consumer responsibilities"
    - Data and information stored in the cloud
    - Access security

!!! example "Example: Cloud SQL database"
    - Cloud provider: Maintaining the actual database
    - Consumer: Data ingested into the database

![Shared responsibility](img/shared-responsibility.svg)

!!! info "Service Models"
    - `SaaS` - Software As A Service (e.g., Outlook email, Calendar, Microsoft Office 365)
    - `PaaS` - Platform As A Service (e.g., Azure SQL Database, Azure App Service)
    - `IaaS` - Infrastructure As A Service (e.g., Azure VM, Azure storage accounts)
    - `On-prem` - On Premises

!!! warning "Consumer is always responsible for"
    - Information and data stored in the cloud
    - Devices allowed to connect to the cloud
    - Account and identities of people, services, and devices

!!! warning "Cloud provider is always responsible for"
    - The physical datacenter
    - The physical network
    - The physical hosts

:exclamation: Your service model determines responsibilities for things like OS, network controls, applications, and identity and infrastructure.

### 1.1.2. :cloud: Define cloud models

`Cloud model` defines the deployment type of cloud resources. There are 3 main cloud models:

1. **Private Cloud** 
   - Used by a single entity
   - Provides greater control but higher cost
   - Can be hosted on-site or off-site

2. **Public Cloud**
   - Built, controlled, and maintained by 3rd party provider
   - Available to general public
   - Key difference from private cloud is public availability

3. **Hybrid Cloud**
   - Uses both public and private clouds
   - Allows for surge capacity and extra security layer

!!! info "Key comparative aspects"
    | Public Cloud | Private Cloud | Hybrid Cloud |
    | ------------ | ------------- | ------------ |
    | No capital expenditures to scale up | Complete control over resources and security | Most flexibility |
    | Quick provisioning and deprovisioning | Data not collocated with other organizations | Organizations determine where to run applications |
    | Pay only for what you use | Hardware must be purchased for startup and maintenance | Control over security, compliance, and legal requirements |
    | Less control over resources and security | Responsible for hardware maintenance and updates | |

!!! tip "Additional cloud scenarios"
    - **Multi-cloud**: Use of multiple public cloud providers
    - **Azure Arc**: Manages cloud environment across different deployments
    - **Azure VMware Solution**: Run VMware workloads in Azure

### 1.1.3. :money_with_wings: Describe the consumption-based model

Two types of expenses to consider:

1. `Capital expenditure (CapEx)`: One-time, up-front expenditure for tangible resources
2. `Operational expenditure (OpEx)`: Spending on services or products over time

:bulb: Cloud computing falls under **OpEx** as it operates on a consumption-based model.

!!! success "Benefits of Consumption-based model"
    - No upfront costs
    - Pay only for resources used
    - Ability to scale resources as needed

!!! danger "Cons of traditional datacenters"
    - Risk of overestimating or underestimating resource needs
    - Potential for wasted money or decreased performance
    - Long time to fix under-provisioned datacenter

#### 1.1.3.1. :scales: Compare Cloud pricing models

Cloud computing benefits help you:

- Plan and manage operating costs
- Run infrastructure more efficiently
- Scale as business needs change

### 1.1.4. :brain: Knowledge Check

1. What is cloud computing?
    - :white_check_mark: **Delivery of computing services over the internet.**
...
2. Which cloud model uses some datacenters focused on providing cloud services to anyone that wants them, and some data centers that are focused on a single customer?
    - Public cloud
    - :white_check_mark: **Hybrid cloud**
    - Multi-cloud

3. According to the shared responsibility model, which cloud service type places the most responsibility on the customer?
    - :white_check_mark: **Infrastructure as a Service (IaaS)**
    - Software as a Service (SaaS)
    - Platform as a Service (PaaS)

### 1.1.5. :star: Describe the benefits of using cloud services

#### 1.1.5.1. :chart_with_upwards_trend: High availability and scalability

When building or deploying a cloud app, two key considerations are:
1. Uptime (availability)
2. Ability to handle demand (scale)

##### 1.1.5.1.1. :up: High Availability

!!! info "High Availability"
    - Focuses on ensuring maximum availability, regardless of disruptions or events
    - Service availability guarantees are part of the service level agreements (SLAs)

!!! note "SLA (Service Level Agreement)"
    - Formal agreement between service provider and customer
    - Guarantees a stated level of service
    - Presented as a percentage (uptime vs downtime)
    - 100% = Always available
    - 0% = Never available

!!! warning "100% uptime is impossible"
    - Services need downtime for repairs/upgrades
    - Every component would need duplication
    - Backup components must instantly take over without interaction

:exclamation: Common SLAs: 99%, 99.9%, 99.95%
:memo: Note the significant difference between 99% and 99.9%

##### 1.1.5.1.2. :arrow_up_down: Scalability

!!! info "Scalability"
    - Ability to adjust resources to meet demand
    - Helps handle peak traffic without overwhelming systems
    - Pay only for what you use (Consumption-based model)

Two types of scaling:

###### 1.1.5.1.2.1. :arrow_up: Vertical Scaling
- Add processing power (CPU/RAM) to VM
- Can scale up or down

###### 1.1.5.1.2.2. :left_right_arrow: Horizontal Scaling
- Deploy additional VMs or containers
- Can be automatic or manual

#### 1.1.5.2. :shield: Reliability and predictability

##### 1.1.5.2.1. :tools: Reliability
...
!!! info "Reliability"
    ...
    - Cloud's decentralized design supports reliable and resilient infrastructure
    - Deploy resources globally for redundancy

##### 1.1.5.2.2. :crystal_ball: Predictability

Influenced by the Microsoft Azure Well-Architected Framework:

###### 1.1.5.2.2.1. :speedboat: Performance Predictability

!!! info "Performance concepts"
    - `Autoscaling`: Deploy additional resources to meet demand
    - `Load balancing`: Redirect overload to less stressed areas
    - `High availability`: Ensure continuous operation

###### 1.1.5.2.2.2. :moneybag: Cost Predictability

!!! info "Cost management"
    - Track resources in real-time
    - Monitor efficient resource usage
    - Apply data analytics for better resource planning
    - Use `Total Cost of Ownership (TCO)` or `Pricing Calculator` for estimates

#### 1.1.5.3. :lock: Security and governance

!!! tip "Benefits"
    - Templates ensure resources meet standards and regulations
    - Easy updates to deployed resources as standards change
    - Cloud-based auditing flags non-compliant resources
    - Automatic software patches and updates (depending on model)
    - Robust protection against DDoS attacks

:bulb: Establish good governance early for an updated, secure, and well-managed cloud footprint.

#### 1.1.5.4. :wrench: Manageability in the cloud

Two types of manageability:

##### 1.1.5.4.1. :gear: Management of the cloud

!!! info "Capabilities"
    - Automatic resource scaling
    - Deployment via preconfigured templates
    - Health monitoring and automatic resource replacement
    - Real-time performance alerts

##### 1.1.5.4.2. :computer: Management in the cloud

!!! info "Management methods"
    - Web portal
    - Command line interface (CLI)
    - APIs
    - PowerShell

#### 1.1.5.5. :brain: Knowledge Check

1. Which type of scaling involves adding or removing resources to meet demand?
    - Vertical scaling
...
2. What is characterized as the ability of a system to recover from failures and continue to function?
    - :white_check_mark: **Reliability**
    - Predictability
    - Scalability

### 1.1.6. :cloud: Describe Cloud Service Types

#### 1.1.6.1. :balance_scale: Shared Responsibility model

![shared responsibility](./img/shared-responsibility.svg)

#### 1.1.6.2. :building_construction: Describe Infrastructure as a Service (IaaS)

!!! info "IaaS Overview"

    - Most flexible cloud service category
...
:bulb: IaaS is like renting hardware in a cloud datacenter with full control.

##### 1.1.6.2.1. :briefcase: Scenarios

Common IaaS use cases:

1. `Lift-and-shift migration`: Move on-premises setup to cloud infrastructure
2. `Testing and development`: Rapidly replicate and manage dev/test environments


#### 1.1.6.3. :gear: Describe Platform as a Service (PaaS)

!!! info "PaaS Overview"
    - Middle ground between IaaS and SaaS
    - Cloud provider maintains core infrastructure

!!! tip "Cloud Provider Responsibilities"
...
!!! note "PaaS Advantages"
    - No need to worry about licensing or patching for OS and databases
...
##### 1.1.6.3.1. :briefcase: Scenarios

Common PaaS use cases:

1. `Development Framework`:
   - Build and customize cloud-based applications
   - Similar to creating Excel macros
   - Includes built-in cloud features (scalability, high-availability, multi-tenant capability)
   - Reduces coding requirements

2. `Analytics or business intelligence`:
   - Analyze and mine data
   - Find insights and patterns
   - Predict outcomes for better decision-making

#### 1.1.6.4. :computer: Describe Software as a Service (SaaS)

!!! info "SaaS Overview"
    - Most complete cloud service model
    - Renting or using fully developed applications
    - Least flexible but easiest to set up
    - Minimal technical knowledge required

!!! example "Common SaaS Examples"
    - Email
    - Financial software
    - Messaging applications
    - Connectivity software

!!! tip "User Responsibilities"
    - Data input
    - Device management
    - User access control

:bulb: Almost everything else is managed by the cloud provider.

##### 1.1.6.4.1. :briefcase: Scenarios
...
2. What type of cloud service type would a Finance and Expense tracking solution typically be in?
   ...
   - Platform as a Service (PaaS)
   - :white_check_mark: **Software as a Service (SaaS)**

## 1.2. :cloud: Describe Azure Architecture and services

### 1.2.1. :building_construction: Describe the core architectural components of Azure

!!! info "Core Components"
    - Physical organization: Datacenters, availability zones, and regions
    - Organizational structure: Resources, resource groups, subscriptions, and management groups

#### 1.2.1.1. :key: Get started with Azure accounts

!!! tip "Azure Account Structure"
    - One Azure account can create multiple subscriptions
    - Separate subscriptions for different departments (e.g., development, marketing, sales)
    - Resources are created within each subscription

![Account Scope Levels](./img/account-scope-levels.png)

##### 1.2.1.1.1. :sandbox: Microsoft Learn sandbox

Creates a temporary subscription added to your Azure account for learning purposes.

#### 1.2.1.2. :computer: Explore the Learn Sandbox

##### 1.2.1.2.1. :powershell: Task 1: Use the PowerShell CLI
...
##### 1.2.1.2.2. :shell: Task 2: Use the BASH CLI

Switch to bash in PowerShell with `bash` command
...
##### 1.2.1.2.3. :keyboard: Task 3: Use Azure CLI interactive mode

!!! info "Interactive Mode Features"
    - Autocompletion
...
:bulb: No need to enter `az` for every command in interactive mode
:door: Exit with `exit` command

#### 1.2.1.3. :earth_americas: Describe Azure physical infrastructure

!!! info "Core Architectural Components"
    1. Physical Infrastructure
    2. Management Infrastructure

!!! note "Azure Datacenters"
    - Similar to large corporate datacenters
    - Resources in racks with dedicated power, cooling, and networking
    - Grouped into Azure Regions or Azure Availability Zones for resiliency and reliability
